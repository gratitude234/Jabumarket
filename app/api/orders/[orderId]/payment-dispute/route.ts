...
export async function POST(
  ...
  try {
    ...
    // Reset to unpaid — buyer sees the payment card again
    await admin
      .from('orders')
    ...
    const notifBody  = 'Vendor could not confirm your transfer. Please check and resend, or contact them in chat.'
    ...
    if (order.conversation_id) {
      try {
        const msgBody = '⚠️ I could not confirm your transfer. Please check and resend, or message me if you need help.'
