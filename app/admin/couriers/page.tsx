      ...
      <div className="rounded-3xl border bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600">Verify, activate, and feature campus transport providers in the directory.</p>
          </div>
              ...
              {rows.map((r) => {
                ...
                return (
                  <tr key={r.id} className="border-t">
                    ...
                    <td className="px-4 py-3">
                      <div className="font-semibold text-zinc-900">{r.name ?? "Unnamed driver"}</div>
